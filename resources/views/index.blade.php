            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">مشترکین فعال</span>
                            <span class="info-box-number">{{ $account->getCountByStatus('active') }} مجموعه</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">مشترکین غیرفعال</span>
                            <span class="info-box-number">{{ $account->getCountByStatus('deactive') }} مجموعه</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        <span class="info-box-icon bg-warning elevation-1"><i class="fa fa-question"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">مشترکین در انتظار</span>
                            <span class="info-box-number">{{ $account->getCountByStatus('suspend') }} مجموعه</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
