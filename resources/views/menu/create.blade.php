                    ...
                    <form action="{{ route('menu.store') }}" method="POST">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ایجاد منو جدید</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="parent_id" class="form-control">
                                            ...
                                            @foreach ($menus as $menu)
                                                <option
                                                    {{ ($menu->id == old("parent_id")) ? 'selected' : '' }} value="{{ $menu->id }}">{{ $menu->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="url" class="form-control" style="direction: ltr;"
                                               placeholder="Route..." value="{{ old("url") }}">
                                    </div>
                                </div>
                                <div class="row mt-2">
