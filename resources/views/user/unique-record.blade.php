                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="account" class="custom-select form-control select2">
                                            ...
                                            @foreach ($accounts as $account)
                                                <option @selected(request('account') == $account->id) value="{{ $account->id }}">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <a href="{{route('user.visitRecord',$query)}}" class="btn btn-warning me-sm-3 me-1"> واحدسازی</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                            ...
                                            <tbody>
                                                @foreach ($records as $key=> $record)
                                                    <tr>
                                                        ...
                                                        <td>{{ convertToPersian($record->count) }}</td>
                                                        <td>{{ zaman($record->count) }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
